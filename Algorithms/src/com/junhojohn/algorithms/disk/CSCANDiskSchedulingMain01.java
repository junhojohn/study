...
public class CSCANDiskSchedulingMain01 {
	...
	public static void main(String[] args) {
		...
		for(int i = diskAccessPoint.length-1 ; i > indexOfCurrentPoint ; i --){
			pathMovement[(diskAccessPoint.length) - (i-indexOfCurrentPoint)] = diskAccessPoint[i];
		}
